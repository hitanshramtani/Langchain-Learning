...
class Review(BaseModel):
    ...
    sentiment: Literal["pos","neg"] = Field(description="the sentiment of the review either postive or negative")
    rating: int = Field(description="the rating of the review out of 10")
